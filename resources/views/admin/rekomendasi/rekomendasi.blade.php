                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$24.8k</span> <span>/
                                        $18.2k</span></p>
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px">
                            <div class="progress-bar rounded" role="progressbar" style="width: 95%"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$2.4k</span> <span>/
                                        1.8k</span></p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px">
                            <div class="progress-bar rounded" role="progressbar" style="width: 42%"
                            ...
                            <div class="d-flex align-items-center">
                                <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 zindex-2">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="../../assets/img/avatars/15.png"
                                            alt="Avatar" />
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    ...
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        ...
                                        <img class="rounded-circle" src="../../assets/img/avatars/16.png"
                                            alt="Avatar" />
                                    </li>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$980</span> <span>/ $420</span>
                                </p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="progress mb-3 rounded rounded" style="height: 8px">
                            <div class="progress-bar rounded" role="progressbar" style="width: 68%"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$8.5k</span> <span>/
                                        $2.43k</span></p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="progress mb-3 rounded" style="height: 8px">
                            <div class="progress-bar rounded" role="progressbar" style="width: 72%"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$52.7k</span> <span>/
                                        $28.4k</span></p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
                    ...
                    <div class="card-body border-top">
                        ...
                        <div class="progress mb-3 rounded" style="height: 8px">
                            <div class="progress-bar rounded" role="progressbar" style="width: 35%"
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="bg-lighter px-2 py-1 rounded-2 me-auto mb-3">
                                <p class="mb-1"><span class="fw-medium text-heading">$1.3k</span> <span>/
                                        $655</span></p>
                                <span class="text-body">Total Budget</span>
                            </div>
                            <div class="text-end mb-3">
