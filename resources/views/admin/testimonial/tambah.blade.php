                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            placeholder="Masukan Nama" name="nama" aria-label="Masukan Nama"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="basic-icon-default-company" class="form-control"
                                            placeholder="Masukan Jabatan" name="jabatan" aria-label="Masukan Jabatan"
                                            aria-describedby="basic-icon-default-company2" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-icon-default-email">Isi</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i class="mdi mdi-comment"></i></span>
                                        <input type="text" id="basic-icon-default-email" class="form-control" name="isi"
                                            placeholder="Masukan Isi" aria-label="Masukan Isi"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="file" id="basic-icon-default-phone" class="form-control"
                                            name="foto" placeholder="Masukan Foto" aria-label="Masukan Foto"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input id="basic-icon-default-message" class="form-control" name="urut"
                                            placeholder="Masukan Urut" aria-label="Masukan Urut"
