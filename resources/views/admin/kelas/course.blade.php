            ...
            <div class="card p-0 mb-4">
                <div class="card-body d-flex flex-column flex-md-row justify-content-between p-0 pt-4">
                    <div class="app-academy-md-25 card-body py-0">
                        <img src="{{ asset('tadmin/assets/img/illustrations/bulb-light.png') }}"
                    ...
                    <div class="app-academy-md-25 d-flex align-items-end justify-content-end">
                        <img src="{{ asset('tadmin/assets/img/illustrations/pencil-rocket.png') }}" alt="pencil rocket"
                    ...
                    <div class="row gy-4 mb-4">
                        <div class="col-sm-6 col-lg-4">
                            <div class="card p-2 h-100 shadow-none border">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-1.png') }}"
                                            alt="tutor image 1" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                            4.4 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span
                                                class="fw-normal">(1.23k)</span>
                                        </p>
                                    </div>
                                    <a href="{{route('detail-kelas',1)}}" class="h5">Basics of Angular</a>
                                    <p class="mt-2">Introductory course for Angular and framework basics in web
                                        development.</p>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card shadow-none border p-2 h-100">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-2.png') }}"
                                            alt="tutor image 2" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div
                                        class="d-flex justify-content-between align-items-center mb-3 pe-xl-3 pe-xxl-0">
                                        <span class="badge rounded-pill bg-label-danger">UI/UX</span>
                                        <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                            4.2 <span class="text-warning"><i
                                                    class="mdi mdi-star me-1"></i></span><span class="fw-noraml">
                                                (424)</span>
                                        </p>
                                    </div>
                                    <a class="h5" href="{{route('detail-kelas',1)}}">Figma & More</a>
                                    <p class="mt-2">Introductory course for design and framework basics in web
                                        development.</p>
                                    <p class="d-flex align-items-center"><i class="mdi mdi-timer-outline me-2"></i>16
                                        hours</p>
                                    <div class="progress rounded-pill mb-4" style="height: 8px">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card shadow-none border p-2 h-100">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-3.png') }}"
                                            alt="tutor image 3" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <p class="d-flex align-items-center justify-content-center gap-1 mb-0">
                                            5 <span class="text-warning"><i class="mdi mdi-star me-1"></i></span><span
                                                class="fw-noraml"> (12)</span>
                                        </p>
                                    </div>
                                    <a class="h5" href="{{route('detail-kelas',1)}}">Keyword Research</a>
                                    <p class="mt-2">
                                        Keyword suggestion tool provides comprehensive details & keyword suggestions.
                                    </p>
                                    <p class="d-flex align-items-center"><i class="mdi mdi-timer-outline me-2"></i>7
                                        hours</p>
                                    <div class="progress rounded-pill mb-4" style="height: 8px">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card shadow-none border p-2 h-100">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-4.png') }}"
                                            alt="tutor image 4" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a class="h5" href="{{route('detail-kelas',1)}}">Basics to Advanced</a>
                                    <p class="mt-2">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card shadow-none border p-2 h-100">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-5.png') }}"
                                            alt="tutor image 5" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a class="h5" href="{{route('detail-kelas',1)}}">Art & Drawing</a>
                                    <p class="mt-2">
                                    ...
                                    <a class="w-100 btn btn-outline-primary" href="{{route('detail-kelas',1)}}"><i
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="card shadow-none border p-2 h-100">
                                <div class="rounded-2 text-center mb-3">
                                    <a href="{{route('detail-kelas',1)}}"><img class="img-fluid"
                                            src="{{ asset('tadmin/assets/img/pages/app-academy-tutor-6.png') }}"
                                            alt="tutor image 6" /></a>
                                </div>
                                <div class="card-body p-3 pt-2">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a class="h5" href="{{route('detail-kelas',1)}}">Basics Fundamentals</a>
                        ...
                        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
                            ...
                            <div
                                ...
                                <img class="img-fluid scaleX-n1-rtl"
                                    src="{{ asset('tadmin/assets/img/illustrations/boy-app-academy.png') }}"
                    ...
                    <div class="card shadow-none bg-label-danger h-100">
                        <div class="card-body d-flex justify-content-between flex-wrap-reverse">
                            ...
                            <div
                                class="w-100 app-academy-sm-40 d-flex justify-content-center justify-content-sm-end h-px-150 mb-3 mb-sm-0">
                                <img class="img-fluid scaleX-n1-rtl"
                                    src="{{ asset('tadmin/assets/img/illustrations/girl-app-academy.png') }}"
            ...
            <div class="card">
                <div class="card-body row gy-4">
                    <div class="col-sm-12 col-lg-4 text-center pt-md-5 px-3">
                        <span class="badge bg-label-primary mb-3"><i
                                class="mdi mdi-wallet-giftcard mdi-36px"></i></span>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card shadow-none border h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    The Fender Acoustic Guitar is the best choice for both beginners and professionals
                                    offering
                                    a great sound.
                                </p>
                            </div>
