                ...
                <div class="col-lg-8">
                    ...
                    <div class="card academy-content shadow-none border">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-0 pt-1">
                                Learn web design in 1 hour with 25+ simple-to-use rules and guidelines — tons of amazing
                                web
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="me-5">
                                    ...
                                    <p class="text-nowrap"><i class="mdi mdi-web mdi-24px me-2"></i>Languages: English
                                    </p>
                                    <p class="text-nowrap"><i class="mdi mdi-content-copy mdi-24px me-2"></i>Captions:
                                        Yes</p>
                                </div>
                                <div>
                                    <p class="text-nowrap"><i class="mdi mdi-pencil-outline mdi-24px me-2"></i>Lectures:
                                        19</p>
                                    <p class="text-nowrap">
                            ...
                            <p class="mb-4">
                                ...
                                development with HTML5 & CSS3. Scroll to the bottom of this page to check out that
                                course,
                            ...
                            <div class="d-flex justify-content-start align-items-center user-name">
                                <div class="avatar-wrapper">
                                    <div class="avatar avatar-sm me-2">
                                        <img src="{{asset('tadmin/assets/img/avatars/1.png')}}" alt="Avatar"
                        ...
                        <div class="accordion-item shadow-none border border-bottom-0 active my-0 overflow-hidden">
                            <div class="accordion-header border-0" id="headingOne">
                                <button type="button" class="accordion-button bg-lighter rounded-0"
                                    data-bs-toggle="collapse" data-bs-target="#chapterOne" aria-expanded="true"
