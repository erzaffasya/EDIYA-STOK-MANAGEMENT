      ...
      <div class="container">
          <div class="cs_main_header_in">
              <div class="cs_main_header_left">
                ...
                <a class="cs_site_branding" href="/" style="margin-right: 15px;">
                <!-- <img id="sparkling-logo" class="stars" src="{{ asset('tlandingpage/assets/img/stars.png') }}" alt="starts" width="16px">
                    <img  src="{{ asset('tlandingpage/assets/img/logo-white.png') }}" alt="Logo"> -->
                    <img src="{{asset('tlandingpage/assets/img/ems star.gif')}}" alt="ems star" srcset="ems star" width="50px">
                </a>
        <div class="stars "></div>


                  <div class="cs_nav cs_primary_font fw-medium " style="margin-left: 40px">
                      <ul class="cs_nav_list fw-medium text-uppercase">
                          ...
                          <li class="menu-item-has-children">
                              <a href="#" onclick="return false;">Main Business</a>
                              <ul>
                      ...
                      <div class="cs_header_contact">
                          ...
                          @if ($getProfil)
                              <div class="cs_header_contact_right">
                                  <h3 class="text-white fw-normal cs_mb_6 cs_fs_13"><a
                                          href="mailto:{{ $getProfil->email }}">{{ $getProfil->email }}</a></h3>
                                  <h3 class="text-white m-0 cs_fs_13"><a
                                          href="https://wa.me/{{ $getProfil->mobile }}">+{{ $getProfil->mobile }}</a>
                                  </h3>
                              </div>
                          @endif
                      </div>
